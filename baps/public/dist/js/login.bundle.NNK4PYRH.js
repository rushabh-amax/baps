...
`;function s(t){if(console.log("in login file : in custom toggle funton"),t.parentNode.querySelector(".custom-toggle-password"))return;let n=t.parentNode,e=document.createElement("span");e.classList.add("custom-toggle-password"),e.style.cursor="pointer",e.style.marginLeft="8px",e.innerHTML=i,n.appendChild(e),console.log("in login file : apped"),e.addEventListener("click",()=>{t.type==="password"?(t.type="text",e.innerHTML=a):(t.type="password",e.innerHTML=i)})}document.addEventListener("DOMContentLoaded",()=>{let t=document.createElement("style");t.innerHTML=`
    .toggle-password { display: none !important; }
    .custom-toggle-password svg {
      vertical-align: middle;
    }
  `,document.head.appendChild(t),document.querySelectorAll('input[type="password"]').forEach(s),new MutationObserver(e=>{e.forEach(l=>{l.addedNodes.forEach(o=>{var r;o.nodeType===1&&(o.matches('input[type="password"]')?s(o):(((r=o.querySelectorAll)==null?void 0:r.call(o,'input[type="password"]'))||[]).forEach(s))})})}).observe(document.body,{childList:!0,subtree:!0})});})();
//# sourceMappingURL=login.bundle.NNK4PYRH.js.map
