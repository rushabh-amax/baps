...
frappe.ui.form.on("Transportation Receiver", {
    onload: function(frm) {
        ...
        frm.fields_dict["transportation_status_r"].grid.cannot_add_rows = true;

        // also hide the "Remove" buttons inside each row
        frm.fields_dict["transportation_status_r"].grid.only_sortable = true;
