...
//     // Main container with centered search
//     let container = $(`
...
//                 let modIcon = mod.icon || 'cube'; // fallback to cube
...
//                     $cards.toggle(query === '' || visibleCards.length > 0);
//                     moduleContainer.toggle(query === '' || visibleCards.length > 0);
//                     noModulesMsg.css('display', query && visibleCards.length === 0 ? 'block' : 'none');
//                     $('#search-term').text(query);
//                 });
//             }
//         } else {
//             // No modules → show "Go Home" button
...
//                 // Try /app/home first, else fallback
